...
public class ProgramDriver {
	...
	public LinkedList<Product> getFreshList(){
	...
	public LinkedList<Product> getClothesList(){
	...
	public Fresh getFreshProduct(String prodName) {
		Fresh temp = null;
	...
	public Clothing getClothingProduct(String prodName) {
		Clothing temp = null;
	...
	public Game getGameProduct(String prodName) {
		Game temp = null;
